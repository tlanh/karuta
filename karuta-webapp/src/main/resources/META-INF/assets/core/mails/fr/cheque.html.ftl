					...
					<table class="table" bgcolor="#ffffff" style="width:100%">
						<tr>
							<td align="center" class="logo" style="border-bottom:4px solid #333333;padding:7px 0">
								<a title="{s${shop_name}href="${shop_url}" style="color:#337ff1">
									<img src="${shop_logo}" alt="{sh${shop_name}>
								</a>
							</td>
						</tr>
...
<tr>
	<td align="center" class="titleblock" style="padding:7px 0">
		<font size="2" face="Open-sans, sans-serif" color="#555454">
			<span class="title" style="font-weight:500;font-size:28px;text-transform:uppercase;line-height:33px">Bonjour {fir${firstname}s${lastname}pan><br/>
			<span class="subtitle" style="font-weight:500;font-size:16px;text-transform:uppercase;line-height:25px">Merci d'avoir effectué vos achats sur {sho${shop_name}pan>
		</font>
	</td>
</tr>
<tr>
				...
				<td style="padding:7px 0">
					<font size="2" face="Open-sans, sans-serif" color="#555454">
						...
						<span style="color:#777">
							...
							<span style="color:#333"><strong>À l'ordre de :</strong></spa${cheque_name}me}<br />
				...
				Si vous avez un compte invité, vous pouvez suivre votre commande via la section <a href="${guest_tracking_url}" style="color:#337ff1">"Suivi invité"</a> sur notre boutique.			</span>
						...
						<tr>
							<td class="footer" style="border-top:4px solid #333333;padding:7px 0">
								<span><a href="${shop_url}" style="color:#337ff1">{shop${shop_name}réalisé avec <a href="http://www.prestashop.com/" style="color:#337ff1">PrestaShop&trade;</a></span>
							</td>
						</tr>
					</table>
				</td>
