...
<body style="-webkit-text-size-adjust: none; background-color: #fff; width: 650px;
    ...
    <table class="table table-mail" style="width: 100%; margin-top: 10px; -moz-box-shadow: 0 0 5px #afafaf;
        ...
        <tr>
			...
			<span class="subtitle" style="font-weight:500;font-size:16px;text-transform:uppercase;line-height:25px">Thank you for creating a 
                            USER account at {shop_name}.</span>
		</font>
                        </td>
                    </tr>
                    <tr>
