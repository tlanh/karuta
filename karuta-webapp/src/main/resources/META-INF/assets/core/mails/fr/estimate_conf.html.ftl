				...
				<td style="padding:7px 0">
					<font size="2" face="Open-sans, sans-serif" color="#555454">
						...
						<span style="color:#777">
							<span style="color:#333"><strong>Devis :</strong></span> ${order_name} <br /><br />
							<span style="color:#333"><strong>Date :</strong></span> ${date}
						</span>
					</font>
				</td>
				<td width="10" style="padding:7px 0">&nbsp;</td>
				...
				<td style="padding:7px 0">
					<font size="2" face="Open-sans, sans-serif" color="#555454">
						...
						<span style="color:#777">
							...
							<span style="color:#333"><strong>Date de livraison :</strong></span> ${delivery_date}
						</span>
					</font>
				</td>
				<td width="10" style="padding:7px 0">&nbsp;</td>
...
<tr>
	<td class="linkbelow" style="padding:7px 0; text-align: justify; text-justify: inter-word;"">
		<font size="2" face="Open-sans, sans-serif" color="#555454">
			<span>
			L'information ci-dessus n'est pas une facture et seulement une estimation des services et produits décrits ci-dessus. Cette estimation est non contractuelle.<br />
			Si vous avez des questions concernant ce devis, contactez Mathieu Lengagne, 06 76 78 53 96, mathieu.lengagne@laposte.net.
			</span>
		</font>
	</td>
</tr>
<tr>
	<td class="linkbelow" style="padding:7px 0">
		<font size="2" face="Open-sans, sans-serif" color="#555454">
			<span>
				Vous pouvez accéder à tout moment au suivi de vos commandes et télécharger vos factures dans <a href="${history_url}" style="color:#337ff1">"Historique des commandes"</a> de la rubrique <a href="${my_account_url}" style="color:#337ff1">"Mon compte"</a> sur notre site.			</span>
		</font>
	</td>
</tr>
