...
public class Ning {
	...
	public Ning() {
		...
		NingClient ningClient = new NingClient(DEFAULT_NETWORK, consumerAuth, DEFAULT_XAPI_HOST, DEFAULT_HTTP_PORT,
				DEFAULT_HTTPS_PORT);
		try {
	...
	public PagedList<Activity> getActivites() {
		...
		Activities.Lister lister = a.listerForRecent(ActivityField.title, ActivityField.type, ActivityField.author,
	...
	public String getXhtmlActivites() {
		...
		do {
			...
			for (Activity act : acts) {
				...
				/*
				 * Author auth = act.getAttachedToAuthorResource(); if(act.getAuthor()!=null &&
				 * auth!=null) ningActivity.setAuthor(auth.getFullName());
				 * if(act.getCreatedDate()!=null)
				 * ningActivity.setCreatedDate(act.getCreatedDate().toString());
				 * ningActivity.setDescription(act.getDescription());
				 * if(act.getContentId()!=null)
				 * ningActivity.setId(act.getContentId().toString()); if(act.getTitle()!=null)
				 * ningActivity.setTitle(act.toString());
				 * 
	...
	static String toString(Activity act) {
		String base = "activity of type " + act.getType() + ", title '" + act.getTitle() + "', author: "
				+ act.getAuthor();
