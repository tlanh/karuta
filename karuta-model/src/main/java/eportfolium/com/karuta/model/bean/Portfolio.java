...
public class Portfolio implements Serializable {
	...
	public Portfolio(String id, Credential credential, Long modifUserId, int active) {
		this.id = id;
	...
	public Portfolio(String id, String rootNode, Credential credential, String modelId, Long modifUserId,
			Date modifDate, int active) {
		this.id = id;
	...
	@Column(name = "portfolio_id", unique = true, nullable = false, length = 36)
	public String getId() {
		return this.id;
	}
