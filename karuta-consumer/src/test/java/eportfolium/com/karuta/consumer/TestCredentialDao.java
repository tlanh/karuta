...
public class TestCredentialDao {
	...
	public void testGetByUserGroup() {
		List<CredentialGroupMembers> result = credentialDAO.getUsersByUserGroup(3L);
...
//	}
	...
	public void testIsAdmin() {
		boolean result = credentialDAO.isAdmin("1");
	...
	public void testIsUserMemberOfRole() {
		boolean result = credentialDAO.isUserMemberOfRole(1L, 3L);
		Assert.assertEquals(true, result);
