...
/**
 * @author vassoill
 * Le dataProvider est la classe d'accés aux données.
 * Voici l'interface qui définit toutes les méthodes possibles d'un dataProvider.
 * Ces méthodes sont directement inspirées des appels REST existants
 *  */
public interface DataProvider {
	 ...
	 * @param filterParameters Si filtre personnalisé, paramétres du filtre personnalisé
