		...
		if (url != null && url.getProtocol().startsWith("vfs")) {
			...
			try {
				...
				if (urlString.contains(".jar")) {
					...
					// An example URL: "vfs:/devel/jboss-as-7.1.1.Final/standalone/deployments/dulocaldansnosassiettes.ear/dulocaldansnosassiettes.war/WEB-INF/lib/tapestry-core-5.3.4.jar/org/apache/tapestry5/corelib/components/"
					...
					// eg. "jar:file:/devel/jboss-as-7.1.1.Final/standalone/tmp/vfs/deployment6610a892821ddda5/dulocaldansnosassiettes.war-43e2c3dfa858f4d2//WEB-INF/lib/tapestry-core-5.3.4.jar!/org/apache/tapestry5/corelib/components/".
